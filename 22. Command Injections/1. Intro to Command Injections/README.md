<h3>Intro to Command Injections</h3>
...
<table border="1" cellpadding="6" cellspacing="0">
  ...
  <tbody>
    <tr>
      ...
      <td>Occurs when user input is directly used as part of an operating system command.</td>
    </tr>
    <tr>
      <td>Code Injection</td>
      <td>Occurs when user input is directly included within a function that evaluates or executes code.</td>
    </tr>
    <tr>
      <td>SQL Injection</td>
    ...
    <tr>
      <td>Cross-Site Scripting (XSS) / HTML Injection</td>
      <td>Occurs when exact user input is rendered and displayed on a web page without proper sanitization.</td>
    </tr>
  </tbody>
</table>
