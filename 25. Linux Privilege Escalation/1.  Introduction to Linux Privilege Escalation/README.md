<h3>Introduction to Linux Privilege Escalation</h3>
...
<h3>List Current Processes</h3>

@htb[/htb]$ ps aux | grep root
...
<h3>List Current Terminal-Attached Processes</h3>
...
<h3>User's Home Directory Contents</h3>

@htb[/htb]$ ls -la /home/stacey.jenkins/
...
<h3>Sudo - List User's Privileges</h3>
...
<h3>File Systems & Additional Drives</h3>
...
<h3>Find Writable Directories</h3>

@htb[/htb]$ find / -path /proc -prune -o -type d -perm -o+w 2>/dev/null
...
<h3>Find Writable Files</h3>

htb[/htb]$ find / -path /proc -prune -o -type f -perm -o+w 2>/dev/null
