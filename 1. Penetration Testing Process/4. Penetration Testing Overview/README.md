<h3>Penetration Testing Overview</h3>
...
<h3>External Penetration Test</h3>
...
<h3>Internal Penetration Test</h3>
...
<table border="1" cellpadding="6" cellspacing="0">
    ...
    <tbody>
        <tr>
            <td>Blackbox</td>
            <td>Minimal. Only the essential information, such as IP addresses and domains, is provided.</td>
        </tr>
        <tr>
            <td>Greybox</td>
            <td>Extended. Additional information such as specific URLs, hostnames, subnets, and similar is provided.</td>
        </tr>
        <tr>
            <td>Whitebox</td>
            <td>Maximum. Everything is disclosed, giving an internal view of the structure. May include detailed configurations, admin credentials, source code, etc.</td>
        </tr>
        <tr>
            <td>Red-Teaming</td>
            <td>May include physical testing and social engineering. Can be combined with any of the above types.</td>
        </tr>
        <tr>
            <td>Purple-Teaming</td>
            <td>Can be combined with any type but focuses on close collaboration between attackers and defenders.</td>
        </tr>
    </tbody>
</table>
...
<h3>Types of Testing Environments</h3>
