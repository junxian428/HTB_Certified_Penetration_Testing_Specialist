...
@htb[/htb]$ nmap -sV -sC -p- 10.129.42.253
...
<img width="683" height="317" alt="image" src="https://github.com/user-attachments/assets/116a89a3-881b-423b-918f-38bed2cfbdf4" />

Another quick search reveals that the release date of this OS is April 23rd, 2020.

<img width="687" height="657" alt="image" src="https://github.com/user-attachments/assets/397139c5-1917-496c-b4ce-3edbfce5a26d" />
...
<img width="682" height="153" alt="image" src="https://github.com/user-attachments/assets/440d5c18-e804-4109-9645-9ef05730ddcb" />
...
<h3>Attacking Network Services</h3>
...
@htb[/htb]$ nc -nv 10.129.42.253 21
...
@htb[/htb]$ nmap -sC -sV -p21 10.129.42.253
...
@htb[/htb]$ nmap --script smb-os-discovery.nse -p445 10.10.10.40
...
@htb[/htb]$ nmap -A -p445 10.129.42.253
...
7@htb[/htb]$ smbclient -N -L \\\\10.129.42.253
...
7@htb[/htb]$ smbclient \\\\10.129.42.253\\users
...
@htb[/htb]$ smbclient -U bob \\\\10.129.42.253\\users
...
@htb[/htb]$ snmpwalk -v 2c -c public 10.129.42.253 1.3.6.1.2.1.1.5.0

iso.3.6.1.2.1.1.5.0 = STRING: "gs-svcscan"

@htb[/htb]$ snmpwalk -v 2c -c private  10.129.42.253 
...
@htb[/htb]$ onesixtyone -c dict.txt 10.129.42.254
